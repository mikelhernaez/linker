...
camodi_input_data<-readMat("./Tumor_GBM50_to_R.mat")
...
start_time <- Sys.time()
camodi_KIRC_10BS<-LINKER_run(lognorm_est_counts, protein_filtered_idx,  lincs_filtered_idx, Gene_set_Collections, NrCores = 32, Nr_bootstraps = 10)
Sys.time() - start_time
save("camodi_KIRC_10BS",file = "camodi_KIRC_all_10BS")
